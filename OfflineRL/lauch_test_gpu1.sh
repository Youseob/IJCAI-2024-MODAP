...
for dataset in $seq walker2d-random; do
    ...
    CUDA_VISIBLE_DEVICES=1 python examples/train_d4rl.py --algo_name=bayrl_cvar --exp_name=train --train_dynamics=True --task=d4rl-$dataset-v2 --dynamics_save_path=$dataset-20-seed-$seed.th --seed=$seed
